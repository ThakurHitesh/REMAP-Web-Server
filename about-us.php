        		...
        		<div class="row feature_inner">
        			<div class="col-lg-4">
        				<div class="feature_item">
        					<img src="user1.jpg"><br><br>
        					<h4>Hitesh Thakur</h4>
        					<p style="color: #ffffff">Bachelor of Technology Bioinformatics, Jaypee University</p>
        				</div>
        			</div>
                    <div class="col-lg-4">
                        <div class="feature_item">
                            <img src="user3.jpg"><br><br>
                            <h4>Dr. Ankush Bansal</h4>
                            <p style="color: #ffffff">Research Scholar Bioinformatics, Jaypee University</p>
                        </div>
                    </div>
        			<div class="col-lg-4">
        				<div class="feature_item">
        					<img src="user2.jpg"><br><br>
        					<h4>Dr. Tiratha Raj Singh</h4>
        					<p style="color: #ffffff">Associate Professor Bioinformatics, Jaypee University</p>
        				</div>
        			</div>
        		</div>
        	</div>
